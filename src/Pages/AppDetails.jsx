...
const AppDetails = () => {
  ...
  // 🔹 Check if app already installed (on load)
  useEffect(() => {
    if (!app) return;
      ...
      <div className="flex flex-col md:flex-row gap-8">
        ...
        <div className="flex-1">
          ...
          <div className="flex gap-10 mt-6">
              <div>
              <img src={iconD} alt="" />  <Stat label="Downloads" value={app.downloads} />
            </div>
              <div>
                <img src={iconRa} alt="" />  <Stat label="Avg Rating" value={app.ratingAvg} />
            </div>
            <div>
              <img src={iconRe} alt="" />  <Stat label="Reviews" value={app.reviews} />
            </div>
          </div>
